...
namespace P2PFileSync::ManagementAPI {
   ...
   */
  const constexpr static std::string_view GET_CLIENT_INFO_ENDPOINT_V1 = "/api/v1/device";
  const constexpr static std::string_view GET_CLIENT_PEER_INFO_ENDPOINT_V1 = "/api/v1/device/peer";
  const constexpr static std::string_view GET_CLIENT_GROUP_INFO_ENDPOINT_V1 = "/api/v1/device/group";
  const constexpr static std::string_view GET_CLIENT_CERTIFICATE_ENDPOINT_V1 = "/api/v1/device/certificate";
} // namespace P2PFileSync::P2PFileSync::ManagementAPI
